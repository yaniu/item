...
public class ClassActivity extends BaseActivity implements MyView{
    ...
    private ArrayList<Cate_f> f_list;
    ...
    public void initView() {
        ...
        iFan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ClassActivity.this.setResult(20,in);
                finish();
            }
        });
    }
