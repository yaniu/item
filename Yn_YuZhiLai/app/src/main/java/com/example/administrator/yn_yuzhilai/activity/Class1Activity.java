...
import com.example.administrator.yn_yuzhilai.fragment.Cate1_f;
...
public class Class1Activity extends BaseActivity implements MyView{
    ...
    private ArrayList<Cate1_f> f_list;
    ...
    public void initView() {
        ...
        iFan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Class1Activity.this.setResult(20,in);
                finish();
            }
        });
    }
