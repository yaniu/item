...
public class Study_rec extends RecyclerView.Adapter<Study_rec.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.study_rec, parent,false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            rec_pic = (ImageView) itemView.findViewById(R.id.rec_pic);
            rec_text1 = (TextView) itemView.findViewById(R.id.rec_text1);
            rec_text2 = (TextView) itemView.findViewById(R.id.rec_text2);
            rec_text3 = (TextView) itemView.findViewById(R.id.rec_text3);
            rec_text4 = (TextView) itemView.findViewById(R.id.rec_text4);
            lin = (LinearLayout) itemView.findViewById(R.id.rec_lin);
        }
    }
}
